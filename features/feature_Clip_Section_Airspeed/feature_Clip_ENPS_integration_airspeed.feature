...
@Clip_integration_airspeed
Feature: Clip_integration

@Insert_Clip_Object_to_ENPS_airspeed @Smoke @Sanity @C659622
...
@View_Clip_Object_from_ENPS_airspeed @Cancel_Clip_Object_edit_from_ENPS_airspeed @Smoke @Sanity @C653386
...
@Edit_Clip_Object_from_ENPS_airspeed @Smoke @Sanity @C668820
