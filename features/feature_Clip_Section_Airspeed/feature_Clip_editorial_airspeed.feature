...
Background: Open BC_PQ_QA
	...
	And I set QAMODE to "true"


@Mark_Timecode_CG_via_In_Out_button_airspeed 
...
@Mark_Timecode_CG_via_Input_Timecode_airspeed 
...
@Mark_Timecode_CG_via_In_Out_button_frames_airspeed 
...
@Mark_Timecode_CG_via_Input_Timecode_frames_airspeed 
...
@Set_Editorial_Duration_via_Editorial_button_airspeed 
...
@Set_Editorial_Duration_via_Input_Timecode_airspeed 
...
@Set_Editorial_Duration_via_Editorial_button_frames_airspeed 
Scenario: Set_Editorial_Duration_via_Editorial_button
	Given timecode is set to "hmsf"
	And I open "CLIP" tab
...
@Set_Editorial_Duration_via_Input_Timecode_frames_airspeed 
Scenario: Set_Editorial_Duration_via_Input_Timecode
	Given timecode is set to "hmsf"
	And I open "CLIP" tab
...
@Set_in_out_word_for_clip_object_airspeed  
